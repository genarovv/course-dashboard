...
| Риск | Снижение |
|------|----------|
| SQLITE_BUSY при конкурентной записи | Единый writer: обход репозиториев последователен; LLM-задачи ставятся сводом последовательно. Второй обход поверх идущего не начинается: `is_sync_running` → 409, кнопка «обновить сейчас» погашена (D41) |
