...
Язык ответа: все свободнотекстовые поля — "notes" и "why" в точках — пиши
на русском языке (выход читает преподаватель). Названия сущностей ("entity")
и цитаты ("quote") оставляй на языке документа студента: цитата — дословная,
её не переводим.
