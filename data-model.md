...
- **Rubric:** создана → используется ребром (EdgeDef.rubric_id указывает на действующую версию) → заменена новой строкой; старая остаётся навсегда, на неё ссылаются исторические вердикты.
